...
extern uint64_t GetDifficulty(const CBlockIndex* blockindex = NULL);
...
extern UniValue popnode(const UniValue& params, bool fHelp);
extern UniValue popnodelist(const UniValue& params, bool fHelp);
extern UniValue popnodebroadcast(const UniValue& params, bool fHelp);
...
extern UniValue getchainwork(const UniValue& params, bool fHelp);
...
/*popchain ghost*/
extern void uncleblockheaderToJSON(const CBlockHeader& blockheader,UniValue& entry,int blockhight,CAmount unclereward);
